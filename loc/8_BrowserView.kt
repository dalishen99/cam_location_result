package com.ling.gateway.widget
...
import com.ling.base.action.ActivityAction
import com.ling.gateway.custom.PermissionCallback
import com.ling.gateway.ui.activity.ImageSelectActivity
import com.ling.gateway.ui.activity.VideoSelectActivity
...
import com.ling.widget.dialog.InputDialog
import com.ling.widget.dialog.MessageDialog
import com.ling.widget.dialog.TipsDialog
import com.ling.widget.layout.NestedScrollWebView
import java.io.File
...
class BrowserView @JvmOverloads constructor(
    ...
    companion object {
        ...
        init {
            // WebView 调试模式开关
            setWebContentsDebuggingEnabled(AppUtils.isAppDebug())
        }
    }
        ...
        private fun openSystemFileChooser(activity: BaseActivity, params: FileChooserParams, callback: ValueCallback<Array<Uri>>) {
            ...
            if ((mimeTypes != null) && (mimeTypes.isNotEmpty()) && !TextUtils.isEmpty(mimeTypes[0])) {
                ...
                if (mimeTypes.size == 1) {
                    when (mimeTypes[0]) {
                        "image/*" -> {
                            ImageSelectActivity.start(activity, if (multipleSelect) Int.MAX_VALUE else 1, object : ImageSelectActivity.OnPhotoSelectListener {
                        ...
                        "video/*" -> {
                            VideoSelectActivity.start(activity, if (multipleSelect) Int.MAX_VALUE else 1, object : VideoSelectActivity.OnVideoSelectListener {
            ...
            activity.startActivityForResult(Intent.createChooser(intent, params.title), object : BaseActivity.OnActivityCallback {
