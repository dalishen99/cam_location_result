...
class MyXRMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_my_xrmain)
        setInit()
    }
...
//                            callback.invoke(origin, false, false)
    ...
    inner class GeoWebViewClient : WebViewClient() {
        ...
        var loadingDialog: Dialog? = Dialog(this@MyXRMainActivity)
    ...
    private fun showMessageOKCancel(message: String, okListener: DialogInterface.OnClickListener) {
        AlertDialog.Builder(this@MyXRMainActivity)
            .setMessage(message)
    ...
    companion object {
        ...
        private val TAG = MyXRMainActivity::class.java.simpleName
